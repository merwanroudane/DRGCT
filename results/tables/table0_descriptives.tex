...
\toprule
Statistic & SPX 500  $P\_t$ & SPX 500  $V\_t$ & CSI 300  $P\_t$ & CSI 300  $V\_t$ & NI 225  $P\_t$ & NI 225  $V\_t$ \\
\midrule
...
$P_t$ is the daily percentage change in the closing level; $V_t$ is the daily percentage change in trading volume divided by 10, following Section 5 of Hui, Liu and Song (2025).  Ljung--Box statistics use 10 lags.  ADF and KPSS report p-values for the unit-root and stationarity nulls.
\end{minipage}
\end{table}
